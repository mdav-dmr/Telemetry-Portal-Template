    ...
    fluidRow(
      column(width = 7,
       box(title = "Program Origins",
           ...
           solidHeader = T,
           status = "primary",
           h4("The Sea Monster Monitoring Program was created at the Maine DMR partly in response to people being scared of, well, sea monsters! On Friday the 13th at some point in history, a sea dragon was spotted near Vinalhaven. This led to a surge in public interest, as is often the case following sightings of mystical beings. While such events are rare, they can have a significant impact on how people perceive risk when in and on the ocean."),
           h4("In the years following, Maine DMR iniated a preliminary research project to track sea monster activity in State waters. Results from the survey would reveal more activity from sea monsters than was previously expected, and it was determined to solidify the program for continued monitoring into the future.")),
